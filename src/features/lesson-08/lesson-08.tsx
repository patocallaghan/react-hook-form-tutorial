    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Learn to share form state across multiple components using useFormContext for nested component communication.
        </p>
        <a
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-gray-700">
          Use <code className="bg-gray-100 px-2 py-1 rounded">FormProvider</code> and{' '}
          <code className="bg-gray-100 px-2 py-1 rounded">useFormContext</code> to share form state{' '}
          across multiple components.
        </p>
      </div>

      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4">Multi-Step Onboarding Form</h2>
        
        {/* TODO: Implement the multi-step form with context */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-yellow-800">
            <strong>TODO:</strong> Implement multi-step form using FormProvider and useFormContext
          </p>
          <div className="mt-2 text-sm text-yellow-700">
            <p>Steps to complete:</p>
            <ol className="list-decimal list-inside mt-1 space-y-1">
              <li>Import FormProvider and useFormContext from react-hook-form</li>
