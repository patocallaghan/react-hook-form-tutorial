    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Master dynamic form fields using useFieldArray for creating, updating, and managing arrays of form fields.
        </p>
        <a
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
          ...
          <li>Contacts (dynamic array with validation):
        ...
        <p className="text-gray-700">
          Use <code className="bg-gray-100 px-2 py-1 rounded">useFieldArray</code> with{' '}
          <code className="bg-gray-100 px-2 py-1 rounded">append</code>,{' '}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-yellow-800">
            <strong>TODO:</strong> Implement the dynamic contact list using useFieldArray
          </p>
