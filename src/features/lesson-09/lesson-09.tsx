    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Learn to optimize form performance using useWatch for selective
          subscriptions and minimizing re-renders.
        </p>
        <a
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-gray-700">
          Use <code className="bg-gray-100 px-2 py-1 rounded">useWatch</code>{' '}
          for selective subscriptions and{' '}
          <code className="bg-gray-100 px-2 py-1 rounded">React.memo</code> for
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-yellow-800">
            <strong>TODO:</strong> Implement performance-optimized form using
            useWatch
          </p>
