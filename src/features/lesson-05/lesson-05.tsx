    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Learn to manage form state dynamically using watch, setValue, reset, and getValues methods.
        </p>
        <a
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
          ...
          <li>Billing Address (conditional, shown when checkbox is unchecked)</li>
        </ul>
        <p className="text-gray-700">
          ...
          <code className="bg-gray-100 px-2 py-1 rounded">reset</code> for dynamic behavior.
        </p>
      </div>

      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4">Product Configuration Form</h2>
        
        {/* TODO: Implement the dynamic product form here */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-yellow-800">
            <strong>TODO:</strong> Implement the dynamic product configuration form
          </p>
          <div className="mt-2 text-sm text-yellow-700">
            <p>Steps to complete:</p>
            <ol className="list-decimal list-inside mt-1 space-y-1">
              <li>Import useForm, watch, setValue, reset, getValues from react-hook-form</li>
