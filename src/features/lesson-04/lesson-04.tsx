    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Learn how to integrate Zod resolver for powerful schema validation
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-gray-700 mb-4">
          Create a user registration form with complex validation using Zod
          schema:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
          ...
          <li>
            Password (required, min 8 characters, must contain uppercase,
            lowercase, number)
          </li>
        ...
        <p className="text-gray-700">
          Use <code className="bg-gray-100 px-2 py-1 rounded">zodResolver</code>{' '}
          from{' '}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-yellow-800">
            <strong>TODO:</strong> Implement the registration form using Zod
            schema validation
          </p>
