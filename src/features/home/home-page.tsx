...
const lessons = [
  {
    ...
    description: "Introduction to useForm hook, simple form with register and handleSubmit",
  ...
  },
  {
    ...
    description: "useController for custom components and UI library integration",
  ...
  },
  {
    ...
    description: "useWatch for selective subscriptions and minimizing re-renders",
  ...
  },
  {
    ...
    description: "Async validation, server-side validation, and custom validation modes",
  ...
  },
  {
    ...
    description: "Form submission with MSW mocks, error handling, and loading states",
    ...
    <div className="px-4 py-6">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Learn React Hook Form step by step, from basic forms to advanced features.
          Each lesson builds on the previous one with hands-on exercises and tests.
        </p>
      </div>
